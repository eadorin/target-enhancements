...
import { FlagsTargeting, SOCKET_MESSAGE_TYPES_TARGETING } from "./TargetConstants.js";
/**
...
export class TargetsTable {
     ...
     */
    constructor(scope) {
        this.flagKeyTargets = FlagsTargeting.targets; //"targets"
     ...
     * @param {*} target
     */
    async addTarget(source, target, data) {
