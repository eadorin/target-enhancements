...
import { SOURCE_TYPES_TARGETING } from "./TargetConstants.js";
import { TokenTarget } from "./TokenTarget.js";
/**
...
export class NPCTargeting {
     ...
     */
    static async targetTokenHandler(user, token, tf, data) {
        let tt = new TokenTarget(token.id, game.user.id, SOURCE_TYPES_TARGETING.SOURCE_TYPE_TOKEN);
        if (tf) {
